...
export const translations = {
  en: {
    ...
    checkHook: 'Opening Impact Review',
    ...
    defectsTitle: 'What May Make Viewers Leave',
    ...
    aspectMatrixTitle: 'Five-Part Visual Quality Review',
    aspectMatrixSub: 'Star ratings paired with plain-language reactions from a viewer’s perspective',
    ...
    playbookTitle: 'Copy-Ready On-Screen Text',
    playbookBadge: 'Caption Breakdown Guidance',
    playbookDesc: 'Natural lines you can place on the Reel as written—without timing labels, effect names, or editing jargon.',
    ...
    actionableEditsSub: 'Visible, practical changes to the opening, middle, ending, and overall presentation',
    suggestedEdits: 'Suggested Edits',
    fixLabel: 'fix',
    solutionLabel: 'Solution:',
    copyFix: 'Copy Direction',
    copied: 'Copied',
  ...
  ko: {
    ...
    aspectMatrixTitle: '다섯 가지 시각 완성도 리뷰',
    aspectMatrixSub: '별점과 함께 실제 시청자 관점에서 자연스럽게 설명합니다',
    ...
    playbookTitle: '바로 쓸 수 있는 화면 문구',
    playbookBadge: '자막 미입력 보완 가이드',
    playbookDesc: '시간이나 효과 이름 없이 영상에 그대로 붙여 쓸 수 있는 자연스러운 문장입니다.',
    ...
    actionableEditsSub: '첫 장면, 중간 흐름, 결말, 전체 화면에서 바로 바꿀 수 있는 실용적인 제안',
